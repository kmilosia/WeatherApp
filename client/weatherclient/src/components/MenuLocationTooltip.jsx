...
const MenuLocationTooltip = ({removeLocation, setDefaultLocation}) => {
  ...
  return (
    <div className="absolute right-10 mt-0 w-60 bg-slate-700 rounded-md shadow-lg z-10">                   
        <button onClick={setDefaultLocation} className={`${optionStyle} border-b-2 border-slate-800`}>Set as default location</button>                        
