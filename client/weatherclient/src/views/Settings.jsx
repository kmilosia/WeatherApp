...
const Settings = () => {
  ...
  return (
    <div className='fixed top-0 left-0 w-full h-full bg-slate-950 flex flex-col text-white p-6 lg:p-8 z-50'>
        <div className='flex justify-between items-start mb-6 lg:mb-8'>
            <h1 className='text-2xl lg:text-4xl font-semibold'>Settings</h1>
